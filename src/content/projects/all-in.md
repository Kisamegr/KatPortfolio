...
chapterImages:
  ...
  - chapter: "my-role---project-manager"
    images:
      - { src: "/portfolio-assets/figma-source/case-study-04-all-in/screenshot-2026-08-13-21-53-37.png", alt: "All In project management board" }
  - chapter: "approach---double-diamond"
    images:
      - { src: "/portfolio-assets/figma-source/case-study-04-all-in/screenshot-2026-08-13-21-33-35.png", alt: "All In Double Diamond process" }
  - chapter: "result"
    images: []
...
![All In session setup](/portfolio-assets/project-story/all-in-session-setup-01.png)

![All In session setup](/portfolio-assets/project-story/all-in-session-setup-02.png)

### Entering the Table

Participants join the All In session and are placed around the virtual table.

![All In virtual table](/portfolio-assets/project-story/all-in-entering-table.png)
...
![All In round one prompt](/portfolio-assets/project-story/all-in-round-one.png)

Participants expand the question tab and answer by typing or voice note. Sending an answer confirms their contribution.

![All In answer input](/portfolio-assets/project-story/all-in-answering.png)

After answering, all participants return to the table and confirm they’re ready before the next round begins.

![All In ready for the next round](/portfolio-assets/project-story/all-in-ready.png)
