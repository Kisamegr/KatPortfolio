...
year: 2026
services: ["48 hours", "Miro", "Double Diamond", "AI-mediated roundtable concept"]
cover:
  src: "/portfolio-assets/figma-source/case-study-04-all-in/img-2609.jpg"
  alt: "All In project image from the Figma board"
gallery:
...
The session Setup continues The HR add the participants.
...
The question tab will get expanded then you can answer the questions by typing or voice note. if you have sent the answer it means that you have confirm.
...
**48 hours Sprint Plan**

Set the scope and timeline. Facilitate Check- Ins. Keep tasks moving. Support Team Alignment. Final Review.

**Discover** — Role play Conflict Capture Perspectives Collect raw Insights.

**Define** — Cluster 8 themes identify the core need Frame the opportunity.

**Develop** — Explore AI feautures Prioritise the ideas Sketch the user flow.

**Deliver** — Refine the roundtable Create final visuals Prepare the presentation.
